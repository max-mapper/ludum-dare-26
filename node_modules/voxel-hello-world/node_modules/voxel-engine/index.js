...
function Game(opts) {
  ...
  this.materialType = opts.materialType || THREE.MeshBasicMaterial
  ...
  this.materials = texture({
    ...
    materialType: opts.materialType || THREE.MeshBasicMaterial,
...
Game.prototype.applyTextures = function(){}
